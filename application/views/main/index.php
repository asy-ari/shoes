<?php include "header.php"; ?>
    ...
    <div class="container">
        ...
        <header class="jumbotron hero-spacer">
            <h1 align="center">Selamat Datang <br></h1>
            <h2 align="center">di Shoes Shop</h2>
            <p align="center"><a  href="<?php echo base_url()?>/index.php/signup" class="btn btn-primary btn-large">Daftar</a>
            </p>
        </header>
